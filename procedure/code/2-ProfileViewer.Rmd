...
LongProf %>%
  #group_by(Attempt) %>% 
  summarize(Slope = mean(Slope, na.rm = TRUE)) #This calculates the mean slope, based on the Attempt. an average of slopes, m by m throughout the longitudinal profile

# Now we want to figure out the width of the flood-prone area.
DpthBf_Max <- 0.9116 # Insert the maximum bankfull depth from your point/reach of interest here, replacing the 8 left of the hash #
...
ggplot(CrossProf) +
       ...
       ylim(1225,1240) + # Sets the y-axis limits. Adjust this value as you zoom in to the correct area.
       scale_color_gradient(low = "green", high = "brown") +
